...
# Custom CSS to adjust the layout and ensure the input box is at the bottom
st.markdown(
    """
    <style>
    .stApp {
...
def display_report_for_country(country):
...
with tabs[0]:
    display_report_for_country("Israel")

with tabs[1]:
    display_report_for_country("Qatar")

with tabs[2]:
    display_report_for_country("Mexico")

with tabs[3]:
    display_report_for_country("Saudi Arabia")
